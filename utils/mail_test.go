...
func TestMail(t *testing.T) {
	config := `{"username":"mvpmvh@gmail.com","password":"mvpmvh","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "mvpmvh@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "mvpmvh" {
